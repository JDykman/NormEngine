...
// TODO: clean this up and strip it down to only things that are actually used in the engine.
//       - remove unused functions, and make sure the ones that are used are actually useful.
package utils
